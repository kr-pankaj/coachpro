        ...
        <div id="sidebar-scroll" class="flex flex-col flex-1 overflow-y-auto custom-scrollbar px-4 pb-4">
            <nav class="space-y-1">
                ...
                @if(auth()->user()->role === 'superadmin')
                    ...
                    <div class="pt-8 pb-2 px-4">
                        <span class="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Support Desk</span>
                    </div>
                    <x-sidebar-link :href="route('superadmin.kb-categories.index')" :active="request()->routeIs('superadmin.kb-categories.*')" icon="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10">
                        {{ __('KB Categories') }}
                    </x-sidebar-link>
                ...
                @if(isset($resolved_institute))
                    ...
                    @if(auth()->user()->role === 'admin' || auth()->user()->role === 'teacher' || auth()->user()->role === 'receptionist')
                        ...
                        @if(auth()->user()->role !== 'receptionist')
                            ...
                            <x-sidebar-link :href="route('admin.analytics.engagement')" :active="request()->routeIs('admin.analytics.*')" icon="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2zm8-4v-2a2 2 0 00-2-2h-2a2 2 0 00-2 2v4a2 2 0 01-2 2h2a2 2 0 012-2zm8-2v-2a2 2 0 00-2-2h-2a2 2 0 00-2 2v6a2 2 0 01-2 2h2a2 2 0 012-2z">
                                {{ __('Engagement') }}
                            </x-sidebar-link>
