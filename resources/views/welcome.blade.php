...
<footer class="py-10 border-t border-gray-100">
    ...
    <button onclick="window.installPWA()" class="pwa-install-btn fixed bottom-8 left-1/2 -translate-x-1/2 z-[100] items-center gap-2 px-6 py-3 bg-indigo-600 text-white rounded-full font-black text-sm shadow-2xl shadow-indigo-500/40 animate-bounce" style="display: none;">
