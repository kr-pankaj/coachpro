                    ...
                    <form method="POST" action="{{ route('enquiries.store') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="course_interested" id="course_interested" value="{{ old('course_interested') }}" placeholder="e.g. Class 10 Maths, NEET"
                                    class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="status" id="status" required class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm">
                                    ...
                                    <option value="converted" {{ old('status') == 'converted' ? 'selected' : '' }}>Converted (Joined)</option>
                                    <option value="lost" {{ old('status') == 'lost' ? 'selected' : '' }}>Lost (Not interested)</option>
                                </select>
                        ...
                        <div>
                            ...
                            <textarea name="notes" id="notes" rows="3" placeholder="Any specific requirements or conversation details..."
                                class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm resize-none">{{ old('notes') }}</textarea>
